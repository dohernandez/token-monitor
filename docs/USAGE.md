# Token Monitor usage and data guide

[Back to overview](../README.md) · [Architecture](ARCHITECTURE.md) · [Development and recovery](DEVELOPMENT.md)
...
replay inflation. Back up the cache and app before accounting migrations; see the development guide.
...
The alert legend lives in Settings, matching Disk Monitor, and explains menu badge thresholds, priority, stale retention and unknown coverage. Usage/Subscriptions navigation is hidden on Settings and Info; Back restores the prior page/provider selection. The persistent footer and fixed Back remain available.
